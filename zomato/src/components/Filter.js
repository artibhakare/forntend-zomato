                    ...
                    <div className="row">
                        <div className="col-12 col-md-5 col-lg-4 col-xl-3">
                            <div className="filterSection">
                                ...
                                <div className="fs-subheading my-2">Sort</div>
                                <div className="mb-4 sort-options">
                                    <div className="my-2">
                                            ...
                                            <div key={index} className="row result-box" onClick={() => this.goToRestaurant(item)}>
                                                ...
                                                <div className="row">
                                                    <div className="col-4 col-md-5 col-lg-3 col-xl-2 bottom-Text">
                                                        <span className="bottom-Text">CUISINES :</span><br/>
                                                        <span className="bottom-Text">COST :</span><br/>
                                                    </div>
                                                    ...
                                                    <br/>
                                                    <span className="bottom-Text-person"> * only FOR TWO person *</span>
                                                </div>
                                            </div>
                                        )
                                    })
