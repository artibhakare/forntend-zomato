        ...
        return (
            <div>
                            ...
                            <div className="col-6 text-end align-self-center">
                                {
                                    ...
                                    :
                                    <>
                                        <button className="btn btn-close-white" onClick={this.openLoginModal} >Log in</button>
                                        <button className="btn btn-close-white" onClick={this.openSignUpModal}>Sign up</button>
                                    </>
                                }
                            </div>
                        </div>
                ...
                <Modal isOpen={isLoginModalOpen} style={customStyle}>
                    <h2>
                        Login
                        <button onClick={this.closeLoginModal} className="btn btn-outline-dark float-end">X</button>
                        <form className="mt-4">
                            {
                                loginError
                                ?
                            ...
                            <div className="text-center">
                                ...
                                <button className="btn  btn-danger" onClick={this.cancelLoginHandler}>Cancel</button>
                            </div>
                            <hr/><h6 style={{textAlign: "center"}}>OR SignUp Using</h6><hr/>
                            <div className="social-section">
                                <FacebookProvider appId="903350173702202">
                                    <LoginButton className="button-fb"
                                    scope="email"
                                    onCompleted={this.handleFacebookResponse}
                                    onError={this.handleFacebookError}
                                    >
                                    <i class="fa fa-facebook-f fa-btn"></i>
                                ...
                                <br/>
                                <GoogleLogin 
                                    clientId="657012119670-tr2657hpnhb6vpibsspnsof8gpcnnjlt.apps.googleusercontent.com"
                ...
                <Modal isOpen={isSignupModalOpen} style={customStyle}>
                    <h2>
                        Sign Up
                        <button onClick={this.closeSignUpModal} className="btn btn-outline-dark float-end">X</button>
                        <form className="mt-4">
                            {
                                signUpError
                                ?
                            ...
                            <div className="text-center">
                                ...
                                <button className="btn  btn-danger" onClick={this.cancelSignUpHandler}>Cancel</button>
                            </div>
                            <hr/><h6 style={{textAlign: "center"}}>OR SignUp Using</h6><hr/>
                            <div className="social-section">
                                <FacebookProvider appId="903350173702202">
                                    <LoginButton className="button-fb"
                                    appId="903350173702202"
